...
from gradenza_api.routes import analytics, canvas_chat, class_pdf_notes, materials, ocr, online_lessons, quiz, study_rooms_sonic, submissions, video
...
app.include_router(study_rooms_sonic.router)
